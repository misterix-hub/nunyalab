                    ...
                    @forelse ($evenements as $evenement)
                        <tr>
                            ...
                            <td class="uk-text-nowrap uk-text-center">
                                ...
                                <a href="{{ route('modifierEvenement', $evenement->id) }}" uk-tooltip="title: Modifier; pos: bottom" class="uk-button uk-button-primary uk-button-small">
                                    <span uk-icon="icon: file-edit"></span>
                                </a>
                                <a href="{{ route('supprimerEvenement', $evenement->id) }}" uk-tooltip="title: Supprimer; pos: bottom" class="uk-button uk-button-danger uk-button-small">
