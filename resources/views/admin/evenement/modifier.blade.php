...
@section('content')
    ...
    <div class="uk-width-1-2@l uk-width-1-1@m uk-width-1-1@s" >
        <div class="admin-menu-bar rajdhani">
            ...
            <small>
                <ul class="uk-breadcrumb">
                    ...
                    <li><span>Modifier évènement</span></li>
                </ul>
            </small>
        ...
        <h4 class="rajdhani uk-margin-remove">Modifier évènement</h4>

        @foreach ($evenements as $evenement)
            <form action="{{ route('updateEvenementForm', $evenement->id) }}" method="post" enctype="multipart/form-data" class="rajdhani">
                @csrf
                <div uk-grid class="uk-grid-small">
                    <div  class="uk-width-1-1@l uk-width-1-1@m uk-width-1-1@s">
                        <div class="uk-inline uk-width-1-1 uk-margin-remove">
                            ...
                            <input class="uk-input uk-width-1-1" type="text" required name="titre" id="titre" value="{{ $evenement->titre }}">
                        </div>
                ...
                <textarea name="description" required id="editor" cols="30" rows="10">{{ $evenement->description }}</textarea><br />
