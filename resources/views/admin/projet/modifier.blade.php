    ...
    <div class="uk-width-1-2@l uk-width-1-1@m uk-width-1-1@s" >
        ...
        @foreach ($projets as $projet)    
            <form action="{{ route('updateProjetForm', $projet->id) }}" method="post" enctype="multipart/form-data" class="rajdhani">
                ...
                <div uk-grid class="uk-grid-small">
                    <div  class="uk-width-1-1@l uk-width-1-1@m uk-width-1-1@s">
                        <div class="uk-inline uk-width-1-1 uk-margin-remove">
                            ...
                            <input class="uk-input uk-width-1-1" type="text" required name="nom" id="nom" value="{{ $projet->nom }}">
                        </div>
                ...
                <textarea name="description" required id="editor" cols="30" rows="10">{{ $projet->description }}</textarea><br />
