        ...
        <div class="admin-menu-bar rajdhani">
            ...
            <small>
                <ul class="uk-breadcrumb">
                    ...
                    <li><span>Ajouter à la gallerie</span></li>
                </ul>
            </small>
            ...
            <h4 class="rajdhani uk-margin-remove">Gallerie</h4><br/>

            <form id="the-form" action="{{ route('add', 'gallerie') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div uk-grid class="uk-grid-small">
                    <div  class="uk-width-1-2@l uk-width-1-1@m uk-width-1-1@s">
                        <div class="uk-inline uk-width-1-1 uk-margin-remove">
                            <textarea class="uk-textarea uk-width-1-1" name="description" id="description" placeholder="Description"></textarea>
                        </div>
                    </div>
                </div><br />

                <b>Sélection du média</b><br />
                ...
                if(xhr.status === 200 && xhr.readyState === xhr.DONE){
                    try {
                        ...
                        if(arr.errorState === 'OK') {
                            alert('Ajouté!');
                            document.location = '{{ route('pg', ['item' => 'gallerie', 'type' => 'list']) }}';
                        }
                    } catch(e) {}
                }
            };
