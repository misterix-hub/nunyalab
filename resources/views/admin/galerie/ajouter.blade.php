...
@section('content')
    ...
    <div class="uk-width-1-2@l uk-width-1-1@m uk-width-1-1@s" >
        <div class="admin-menu-bar rajdhani">
            ...
            <small>
                <ul class="uk-breadcrumb">
                    ...
                    <li><span>Ajouter une image</span></li>
                </ul>
            </small>
        ...
        <h4 class="rajdhani uk-margin-remove">Ajouter une image</h4>
       
        <form action="{{ route('ajouterImageForm') }}" method="post" enctype="multipart/form-data" class="rajdhani">
            @csrf
            <div uk-grid class="uk-grid-small">
                <div  class="uk-width-1-1@l uk-width-1-1@m uk-width-1-1@s">
                    ...
                    <div class="uk-inline uk-width-1-1 uk-margin-remove"><br />
                        <label for="image">Charger l'image</label><br />
